<?php
	...
	$tarifa = ControladorTarifa::ctrMostrartarifa();
	/*echo '<pre class="bg-white">'; print_r($tarifa); echo '</pre>'; */
...
<div class="recorridoPueblo container-fluid bg-white pb-5" id="pueblo">
	...
	<div class="container">
		...
		<h1 class="pt-5 text-center">DESCUBRE TARIFA</h1>	
			...
			<div class="jd-slider slidePueblo">
				...
				<div class="slide-inner">
					...
					<ul class="slide-area">
						...
						<?php foreach ($tarifa as $key => $value): ?>
						...
						<div class="grid-container pt-4 pb-1 pb-lg-3 px-0 px-lg-5">
								...
								<div class="grid-item">
									...
									<img src="<?php echo $servidor.$value["foto_p"]; ?>" class="img-fluid" width="100%">
								...
								<div class="grid-item d-none d-lg-block">
									...
									<img src="<?php echo $servidor.$value['foto_g']; ?>" class="img-fluid" width="100%">
